# content_context.md — Real Content Only (v4)

**Do not invent.** Facts from `Context/personal-site.md`, `Context/resume-context.md`, and v1 `projects.js`.
...
| Field | Value |
|-------|--------|
| Email | hello@giselelarose.com *(update in `site/js/main.js` if the mailbox changes)* |
| GitHub | https://github.com/Gisele66 |
| LinkedIn | *(add in `site/js/main.js` when ready)* |
| Resume PDF | `[Resume PDF — coming soon]` until a file is in `site/assets/resume.pdf` |
